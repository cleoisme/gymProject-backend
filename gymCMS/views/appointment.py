...
def list_all_appointment_types(request):
    ...
    return render(request, "appointment_list.html", {"appointments": appointment_types})
...
def create_an_appointment_type(request):
    if request.method == "POST":
        ...
        if new_appointment_type.is_valid():
            ...
            return redirect(
                "appointment_type_details", appointment_type_id=new_appointment_type.id
            )
    else:
        new_appointment_type = Appointment()
    return render(
        request,
        "create_appointment_type.html",
...
def create_an_appointment(request):
    if request.method == "POST":
        ...
        if new_appointment.is_valid():
            ...
            return redirect("appointment_details", appointment_id=new_appointment.id)
    else:
        new_appointment = Appointment()
    return render(request, "create_appointment.html", {"appointment": new_appointment})
...
def update_an_appointment(request, appointment_id):
    ...
    if request.method == "POST":
        ...
        new_appointment = Appointment()
    return render(request, "update_appointment.html", {"appointment": new_appointment})
...
def delete_an_appointment(request, appointment_id):
    ...
    if request.method == "POST":
        appointment.delete()
        return redirect("list_all_appointments")
    return render(
        request, "delete_appointment_confirm.html", {"appointment": appointment}
    )
